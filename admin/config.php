<?php
// HTTP
define('HTTP_SERVER', 'http://52.27.31.162/admin/');
define('HTTP_CATALOG', 'http://52.27.31.162/');

// HTTPS
define('HTTPS_SERVER', 'http://52.27.31.162/admin/');
define('HTTPS_CATALOG', 'http://52.27.31.162/');
