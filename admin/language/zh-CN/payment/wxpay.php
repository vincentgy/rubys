...
$_['text_payment']       				= '支付方式';
$_['text_wxpay']						= '<img src="view/image/payment/wxpay_coc.png" alt="微信公众号支付接口" title="微信公众号支付" style="border: 1px solid #EEEEEE;" />';
$_['text_success']       				= '成功: 已修改微信公众号支付！';
$_['text_edit']          				= '编辑微信公众号支付';

// Entry
$_['entry_wxpay_mchid'] 				= '商户号';
$_['entry_wxpay_appid'] 				= '公众账号APPID或者应用APPID';
$_['entry_wxpay_key'] 					= 'API密钥';
...
// Error
$_['error_permission']   				= '警告: 无权修改微信公众号支付接口！';
$_['error_wxpay_mchid']      			= '请填写商户号！'; 
$_['error_wxpay_appid']     			= '请填写公众账号APPID或者应用APPID！'; 
$_['error_wxpay_key']        			= '请填写API密钥！'; 
$_['error_wxpay_appsecret']    			= '请填写AppSecret！'; 