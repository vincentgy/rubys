            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><a href="<?php echo HTTP_CATALOG.'index.php?route=product/product&product_id='.$product['product_id']; ?>" target="_blank"><?php echo $product['name']; ?></a></td>
                  ...
                  <td class="text-right"><?php if($product['sent']) { ?><a href="<?php echo $product['update']; ?>" data-toggle="tooltip" title="<?php echo $button_update; ?>" class="btn btn-primary"><i class="fa fa-refresh"></i></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo $product['unpush']; ?>" data-toggle="tooltip" title="<?php echo $button_unpush; ?>" class="btn btn-danger"><i class="fa fa-reply"></i></a><?php }else{ ?><a href="<?php echo $product['push']; ?>" data-toggle="tooltip" title="<?php echo $button_push; ?>" class="btn btn-primary"><i class="fa fa-arrow-right"></i></a><?php } ?></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
...
$('#button-jump').on('click', function() {
	var url = 'index.php?route=weidian/product&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=weidian/product/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
...
$('input[name=\'filter_model\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=weidian/product/autocomplete&token=<?php echo $token; ?>&filter_model=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
