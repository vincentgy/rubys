            ...
            <section id="content">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td></td>
                        <?php foreach ($products as $product) { ?>
                        <td><input type="button" value="<?php echo $button_cart; ?>" class="btn btn-primary btn-block btn-custom" onclick="cart.add('<?php echo $product['product_id']; ?>');" />
                ...
                <div class="buttons">
                    <div class="pull-right"><a href="<?php echo $continue; ?>" class="btn btn-default btn-custom"><?php echo $button_continue; ?></a></div>
                </div>
                <?php } ?>
