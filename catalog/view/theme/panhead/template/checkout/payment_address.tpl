<form class="form-horizontal">
  ...
  <div id="payment-existing">
    <select name="address_id" class="form-control">
      ...
      <option value="<?php echo $address['address_id']; ?>" selected="selected"><?php echo $address['fullname']; ?>, <?php echo $address['country']; ?><?php echo $address['zone']; ?><?php echo $address['city']; ?><?php echo $address['address']; ?>  </option>
      <?php } else { ?>
      <option value="<?php echo $address['address_id']; ?>"><?php echo $address['fullname']; ?>, <?php echo $address['country']; ?><?php echo $address['zone']; ?><?php echo $address['city']; ?><?php echo $address['address']; ?></option>
      <?php } ?>
      <?php } ?>
    </select>
  </div>
  ...
  <div class="buttons clearfix">
    <div class="pull-right">
      <input type="button" value="<?php echo $button_continue; ?>" id="button-payment-address" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-custom" />
    </div>
  </div>
</form>
