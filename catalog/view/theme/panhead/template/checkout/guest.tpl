  ...
  <div class="col-sm-6">
    <fieldset id="address">
      ...
      <div class="form-group required">
        ...
        <input type="text" name="address" value="<?php echo $address; ?>" placeholder="<?php echo $entry_address; ?>" id="input-payment-address" class="form-control" />
      </div>
      <div class="form-group required">
...
<div class="buttons">
  <div class="pull-right">
    <input type="button" value="<?php echo $button_continue; ?>" id="button-guest" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-custom" />
  </div>
</div>
