    ...
    <div class="row"><?php echo $column_left; ?>
        ...
        <div class="<?php echo $class; ?>">
            <section id="content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-shopping-cart">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center td-thumb"><?php if ($product['thumb']) { ?>
                                        <a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-thumbnail" /></a>
                                        <?php } ?>
                                    </td>
                                    <td class="text-left td-product"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
                                    ...
                                    <td class="text-left td-model" data-title="<?php echo $column_model; ?>" ><?php echo $product['model']; ?>
                                    </td>
                                ...
                                <tr>
                                    <td></td>
                                    <td class="text-left td-product"><?php echo $vouchers['description']; ?></td>
                                    <td class="text-left td-model"></td>
                                    <td class="text-left td-qty"><div class="input-group btn-block" style="max-width: 200px;">
                                    ...
                                    <td class="text-right td-price" data-title="<?php echo $column_price; ?>" ><?php echo $vouchers['amount']; ?></td>
                                    <td class="text-right td-total" data-title="<?php echo $column_total; ?>"><?php echo $vouchers['amount']; ?></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                ...
                <div class="buttons">
                    <div class="pull-left"><a href="<?php echo $continue; ?>" class="btn btn-default btn-custom"><?php echo $button_shopping; ?></a></div>
                    <div class="pull-right"><a href="<?php echo $checkout; ?>" class="btn btn-primary btn-custom"><?php echo $button_checkout; ?></a></div>
                </div>
